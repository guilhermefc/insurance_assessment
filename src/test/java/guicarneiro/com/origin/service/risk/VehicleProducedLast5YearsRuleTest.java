...
class VehicleProducedLast5YearsRuleTest {
    ...
    public void testUserVehicleOver5Year() {
        ...
        User userMockVehicle2015 = new User(0, 0, null, 0, null, List.of(0, 0, 1), new Vehicle(2015));
    ...
    public void testUserVehicleEqual5Year() {
        new FakeCalendarMock(2021);
        User userMockVehicle2021 = new User(0, 0, null, 0, null, List.of(0, 0, 1), new Vehicle(2021));
    ...
    public void testUserVehicleUnder5Year() {
        new FakeCalendarMock(2021);
        User userMockVehicle2020 = new User(0, 0, null, 0, null, List.of(0, 0, 1), new Vehicle(2020));
