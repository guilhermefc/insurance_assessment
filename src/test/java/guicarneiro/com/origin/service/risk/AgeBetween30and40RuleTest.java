...
class AgeBetween30and40RuleTest {
    ...
    public void testAgeBetween30and40RuleEqual40() {
        UserApplicationProfile user = new UserApplicationProfile(40, 0, null, 100, MaritalStatus.SINGLE, null, null);
    ...
    public void testAgeBetween30and40RuleGreaterThan40() {
        UserApplicationProfile user = new UserApplicationProfile(41, 0, null, 100, MaritalStatus.SINGLE, null, null);
